  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>BlogPost - EscapeHilonew</title>
          <meta property="og:title" content="BlogPost - EscapeHilonew" />
        </Head>
        <div className="hero">
        ...
        <div className="post-details">
          <div className="container01">
            <svg viewBox="0 0 1170.2857142857142 1024" className="icon">
          ...
          <span className="text01 textXL">posted 18 Sept 2021</span>
          <span className="text02">
            ...
            <span className="text05">Mark Jonson</span>
            <br></br>
          </span>
          <span className="text06">
            <span className="text07">
              ...
              and economic costs will be incurred. These scenarios arenât
              guaranteed, but avoiding them will be very hard. Weâre trying to
        ...
        <div className="container02">
          <div className="story">
            <span className="text08 textLG">
              <span>March 1, 2019</span>
            </span>
            <h3 className="text10 text2XL">
            ...
            <div className="container03">
              ...
              <span className="text20">
                <span className="text21">Kanye West, Producer.</span>
                <span className="text22"></span>
              </span>
            </div>
            <h3 className="text23 text2XL">
              Using Video Games To Generate Clicks
            </h3>
            <span className="text24 textLG">
            ...
            <span className="text27 textLG">
              <span className="text28">
                We are here to make life better. And now I look and look around
                and thereâs so many Kanyes I&apos;ve been trying to figure out
                ...
                love to Phifeâs family Thank you for so much inspiration
              </span>
              <br></br>
              <span></span>
              <br></br>
              <span className="text31">
                ...
                up of influence. All respect prayers and love to Phifeâs family
            ...
            <div className="post">
              <span className="text35 textXL">What people say...</span>
              ...
              <div className="container04">
                <div className="container05">
                  ...
                  <div className="container06">
                    <span className="text36 textSM">JOHN SNOW</span>
                    <div className="container07">
                      <span className="text37 textXS">3 days ago</span>
                    </div>
                  </div>
                </div>
                <SecondaryButton button="FOLLOW"></SecondaryButton>
              </div>
              <span className="text38 textMD">
                <span className="text39">
                  ...
                  because youâre telling them from the off exactly why they
                  should hire you.
                </span>
                <br></br>
              </span>
              ...
              <div className="container08">
                <div className="container09">
                  ...
                  <span className="text40 textXS">150</span>
                  ...
                  <span className="text41 textXS">36</span>
                  <svg viewBox="0 0 1024 1024" className="icon6">
                  ...
                  <span className="text42 textXS">12</span>
                </div>
              ...
              <span className="text44 textSM">Load previous</span>
              <PostReaction
                name="Michael Lewis"
                likes="3"
        ...
        <div className="posts">
          <div className="container12">
            ...
            <h3 className="text46 healine">
              <span className="text47">Before I goÂ </span>
            </h3>
            <span className="text48 textXL">
