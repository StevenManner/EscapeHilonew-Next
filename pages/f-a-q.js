  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>FAQ - EscapeHilonew</title>
          <meta property="og:title" content="FAQ - EscapeHilonew" />
        </Head>
        <div className="section1">
          ...
          <div className="container1">
            ...
            <div className="cards-container">
              ...
              <div className="card2">
                <h6 className="text05 textXL">How many players can play?</h6>
