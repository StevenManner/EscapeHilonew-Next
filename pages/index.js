      ...
      <div className="container">
        ...
        <div className="hero">
          ...
          <div className="container01">
            <div className="container02">
              <h1 className="text">Your story starts with us.</h1>
        ...
        <div className="section1">
          <div className="container03">
            <div className="container04">
              ...
              <h3 className="text07 healine">
                I&apos;ve risen with the soles burned
              </h3>
              <span className="text08 textXL">
            ...
            <div className="cards-container">
              <div className="card1">
                ...
                <h6 className="text10 textXL">Awarded Agency</h6>
              ...
              <div className="card2">
                <div className="container06">
                  <svg viewBox="0 0 1097.142857142857 1024" className="icon02">
                ...
                <h6 className="text12 textXL">Free Revisions</h6>
              ...
              <div className="card3">
                ...
                <h6 className="text14 textXL">Verified Company</h6>
            ...
            <div className="work-with-us">
              <div className="container08">
                ...
                <h3 className="text16 healine">Work with us is a pleasure</h3>
              ...
              <div className="container10">
                ...
                <div className="container12">
                  <h4 className="text23 healine">
                    <span className="text24">Top Notch Services</span>
                    <br></br>
                  </h4>
        ...
        <div className="section2">
          ...
          <div className="growing-company-section">
            ...
            <div className="container14">
              <div className="container15">
                <svg viewBox="0 0 967.4605714285714 1024" className="icon08">
              ...
              <h3 className="text30 healine">A growing company</h3>
              ...
              <div className="container16">
                ...
                <span className="text32">Carefully crafted components</span>
              </div>
              <div className="container18">
                ...
                <span className="text33">Amazing page examples</span>
              </div>
              <div className="container20">
                <div className="container21">
                  <svg viewBox="0 0 1024.5851428571427 1024" className="icon15">
                ...
                <span className="text34">Dynamic components</span>
              </div>
            </div>
          </div>
          <div className="container22">
            ...
            <h3 className="text37 healine">
              It is everything, and it won&apos;t change
            </h3>
            <span className="text38 textXL">
        ...
        <div className="section3">
          <div className="container44">
            <h6 className="text40 textSM">
              <span>ON THE COASTLINE</span>
            </h6>
            <h3 className="text42 healine">We are missing the summer</h3>
            <span className="text43 textXL">
            ...
            <div className="services">
              ...
              <div className="container45">
                ...
                <h1 className="text45 textXL">Grow your market</h1>
              ...
              <div className="container47">
                ...
                <h1 className="text47 textXL">Launch time</h1>
            ...
            <div className="contact">
              ...
              <h2 className="text49">Type in the bellow form</h2>
              <span className="text50 textXL">
              ...
              <div className="form">
                <h1 className="text51">Want to work with us?</h1>
                <span className="text52 textXL">
                  Complete this form and we will get back to you in 24 hours.
                </span>
                <span className="text53 textXS">FULL NAME</span>
                <input
                  type="text"
                  placeholder="Full Name"
                  className="textinput textSM input"
                />
                <span className="text54 textXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="textinput1 textSM input"
                />
                <span className="text55 textXS">MESSAGE</span>
                <textarea
                  cols="80"
                  rows="4"
                  disabled="true"
