  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>Profile - EscapeHilonew</title>
          <meta property="og:title" content="Profile - EscapeHilonew" />
        </Head>
        <div className="image">
          <Header></Header>
          <img
        ...
        <div className="container01">
          ...
          <div className="container06">
            <h3 className="text text2XL">Jenna Stones</h3>
            <div className="container07">
              <svg viewBox="0 0 1024 1024" className="icon">
                <path d="M512 490q44 0 75-31t31-75-31-75-75-31-75 31-31 75 31 75 75 31zM512 86q124 0 211 87t87 211q0 62-31 142t-75 150-87 131-73 97l-32 34q-12-14-32-37t-72-92-91-134-71-147-32-144q0-124 87-211t211-87z"></path>
              </svg>
              <span className="text1 textSM">LOS ANGELES, CALIFORNIA</span>
            </div>
            ...
            <div className="container09">
              <div className="container10">
                <svg viewBox="0 0 1097.142857142857 1024" className="icon4">
