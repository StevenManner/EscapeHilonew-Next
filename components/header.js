  ...
  return (
    <>
      <div data-role="Header" className={`header ${props.rootClassName} `}>
        ...
        <h1 className="heading3 textSM">{props.heading122}</h1>
        ...
        <div data-type="MobileMenu" className="mobile-menu">
          ...
          <div className="bot">
            <svg viewBox="0 0 877.7142857142857 1024" className="icon11">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="icon15">
